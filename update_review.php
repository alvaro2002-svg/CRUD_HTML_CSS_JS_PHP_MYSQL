    ...
    <section class="account-form">
        ...
        ?>
                <form action="" method="post">
                    ...
                    <input type="text" name="title" required maxlength="50" class="box" placeholder="enter review title" value="<?= $fetch_review['title']; ?>">
                    <p class="placeholder">review descripion</p>
                    <textarea name="description" placeholder="enter review description" maxlength="1000" class="box" cols="30" rows="10">
